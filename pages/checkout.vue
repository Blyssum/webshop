...
<template>
    ...
    <div class="text-white font-serif inline-flex p-5 border-x-2 border-white">
        ...
        <div class="flex flex-row-reverse w-1/2 h-8">
            <img src="~assets/images/check.png" @click=" applyPromotionCode()" class="border-2 border-white ml-1" />
            <input placeholder="Rabattcode" v-model="code" class="bg-black border-2 border-white px-2 pt-1 pb-0.5">
        </div>
    </div>
